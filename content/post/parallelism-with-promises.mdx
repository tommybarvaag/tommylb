...
<ComponentSource src="/app/example/parallelism-live-test/_components/parallelism-live-test-all-settled.tsx" />

### React Server Component with async await

<ComponentSource src="/app/example/parallelism-live-test/_components/parallelism-live-test-async-await.tsx" />
