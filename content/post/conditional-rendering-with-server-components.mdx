...
<ComponentSource src="/app/(cv)/cv/_components/show-platform.tsx" forceMount />

Showing of content per platform is abstracted away in the `<ShowPlatformContent />` component.

<ComponentSource src="/app/(cv)/cv/_components/show-platform-content.tsx" />
