  ...
  return (
    <form onSubmit={onSubmit} className={cn("relative w-full", className)} {...props}>
      <input
        ...
        className="block h-8 w-full appearance-none rounded-md border border-zinc-200 bg-zinc-100 py-2 pl-3 pr-3 text-sm placeholder:text-zinc-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-800 focus:ring-offset-1 sm:w-64 sm:pr-12"
      />
