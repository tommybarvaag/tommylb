...
image: { jpg: "/images/blog/why-i-run/runner.jpg", webp: "/images/blog/why-i-commit/runner.webp" }
...
<Image
  variant="blog"
  jpg="/images/blog/why-i-run/runner.jpg"
  webp="/images/blog/why-i-run/runner.webp"
  alt="Runner"
  loading="eager"
/>
...
<StravaRunningGoals variant="cards.small" my={4} />
