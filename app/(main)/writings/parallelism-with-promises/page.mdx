import { ParallelismWithPromisesExample } from "@/app/(main)/writings/parallelism-with-promises/parallelism-with-promises-example";
...
export const metadata = generateWritingsMetadata({
  ...
  description:
    "Learn when to use parallelism with promises and how to fetch data efficiently with React Server Components. Get insights and tips on optimizing your React app performance with parallelism.",
  canonical: "/writings/parallelism-with-promises"
});
