...
export const metadata = generateWritingsMetadata({
  ...
  description:
    "Learn how to create a service principal with a long expiry in Azure AD using the Microsoft Graph API and the Azure CLI.",
  canonical: "/writings/azure-ad-sp-secret-long-expiry"
});
