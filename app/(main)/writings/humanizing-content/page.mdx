import { ActiveWorkYears } from "@/app/_components/active-work-years.tsx";
...
export const metadata = generateWritingsMetadata({
  ...
  description:
    "Explore the art of humanizing digital content to improve readability and engagement. Simple tweaks can make a significant impact on your audience's experience.",
  canonical: "/writings/humanize-your-content"
});
