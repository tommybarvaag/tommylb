...
export const metadata = generateWritingsMetadata({
  ...
  description:
    "This article can help you decide if you need third-party form library or not. We will look at React Hook Form and a traditional HTML5 approach.",
  canonical: "/writings/do-you-need-a-third-party-form-library"
});
