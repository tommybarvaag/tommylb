...
const projectExperienceData: ProjectExperienceItem[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "Throughout the project, Tommy ensured that every technology and tool used was in perfect harmony with the project's goals. His choice of technologies like React, Azure, and the integration of IoT microservices was not just a demonstration of his technical proficiency, but also of his ability to align technology with business objectives."
    ],
    summary:
